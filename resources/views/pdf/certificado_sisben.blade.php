    ...
    <body>
        <div class="row">
            ...
            <p style="text-align: justify; padding-left: 8px; padding-right: 8px;">
                Que la persona relacionada en este documento, se encuentra registrada en la Base de Datos de Potenciales Beneficiarios para Programas Sociales (SISBEN).
                BASE DE DATOS LOCAL DEL MUNICIPIO y según ficha de Clasificación Socioeconomica, presenta la siguiente información:
            </p>
            ...
            <p style="padding-left: 40px; padding-right: 40px;">
                ...
                <br/>
                Base de datos a corte del 20 de Septiembre de 2016.
            </p>

                                ...
                                <ul class="dropdown-menu">                                    
                                    ...
                                    <li class="user-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 text-center">
                                                <a href="{{URL::to('admin_indycom')}}"><i class="fa fa-user-secret"></i> Administración</a>
                                            </div>
                                        </div>
                                        <!-- /.row -->
                                    </li>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="{{URL::to('sisben')}}"><i class="fa fa-th-list"></i> Certificado del SISBEN</a></li>
                        <li><a href="{{URL::to('indycom/registro')}}"><i class="fa fa-th-list"></i> Registro Industria y Comercio</a></li>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>

...
<div class="wrapper">
                            ...
                            <li class="user-body">
                                <div class="row">
                                    <div class="col-xs-6 text-center">
                                        <a href="http://elzulia-nortedesantander.gov.co/index.shtml" target="_blank"><i
                                                    class="fa fa-reply"></i> Página Web</a>
                                    </div>
                                    <div class="col-xs-6 text-center">
                                        <a href="{{URL::to('admin_indycom')}}"><i class="fa fa-user-secret"></i>
                                            Administración</a>
                                    </div>
                                </div>
                                <!-- /.row -->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <img src="{{URL::to('img/escudo.jpg')}}" class="img-circle" alt="Alcaldía de El Zulia"
                     style="width: 90%;">
            </div>
            <!-- sidebar menu: : style can be found in sidebar.less -->
            <ul class="sidebar-menu">
                <li class="header">Menú Principal</li>
                <li><a href="{{URL::to('/')}}"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
                <li><a href="{{URL::to('sisben')}}"><i class="fa fa-sort-amount-asc"></i> Certificado del SISBEN</a>
                </li>
                <li><a href="{{URL::to('indycom/registro')}}"><i class="fa fa-object-ungroup"></i> Registro Industria y
                        Comercio</a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    ...
    @if (!empty(session('error')))
        <div class="col-md-8 col-md-offset-4 mensaje" onclick="ocultar()" style="padding-top: 5%;">
    ...
    @elseif(!empty(session('mensaje')))
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2016-2017 <a href="http://elzulia-nortedesantander.gov.co/index.shtml">Alcaldía
                    Municipal de El Zulia</a>. - Impulsado por <a href="http://cortexinc.org"
                                                                  target="_blank">CortexInc</a></strong>
        </footer>
</div>
<!-- ./wrapper -->

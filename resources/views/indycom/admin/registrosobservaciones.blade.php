        ...
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="{{URL::to('indycom/registros/validados')}}"><i
                                            class="fa fa-check"></i>
                                    Validados <span
                                            class="label label-success pull-right">{{$cant_validados}}</span></a></li>
                            </a></li>
                            <li class="active"><a href="{{URL::to('indycom/registros/observciones')}}"><i class="fa fa-question-circle"></i> Observaciones <span
            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Listado de Registros con Observaciones</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body no-padding">
                            ...
                            <table class="table table-hover table-striped" id="registros">
                                ...
                                @if(count($registros) > 0)
                                    @foreach($registros as $r)
                                        <tr>
                                            <td class="mailbox-star"><a href="#"><i class="fa fa-star text-orange"></i></a>
                                            </td>
                                ...
                                @else
                                    <tr>
                                        <td colspan="6">No se encontraron registros con Observaciones</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>

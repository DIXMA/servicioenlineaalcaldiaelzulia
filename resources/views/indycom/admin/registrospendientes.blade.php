            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="#"><i class="fa fa-inbox"></i> Pendientes <span class="label label-primary pull-right">12</span></a></li>
                        <li><a href="#"><i class="fa fa-envelope-o"></i> Validados</a></li>                       
                    </ul>
                </div>
                <!-- /.box-body -->
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row-border">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="obs_general" id="obs_general" class="form-control" required="true"></textarea>
                            <span style="color: red;" id="error_obs_general"></span>
                        </div>
                        <div class="form-group">
                            <label>Observación Adjunto Documento</label>
                            <textarea name="obs_documento" id="obs_documento" class="form-control" required="true"></textarea>
                            <span style="color: red;" id="error_obs_documento"></span>
                        </div>
                        <div class="form-group">
                            <label>Observación Adjunto Camara de Comercio</label>
                            <textarea name="obs_camaradecomercio" id="obs_camaradecomercio" class="form-control" required="true"></textarea>

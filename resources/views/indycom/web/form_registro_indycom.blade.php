                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="naturalezajuridica" id="naturalezajuridica"
                                        required="true">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="direccionestablecimiento">* Dirección de establecimiento de comercio ubicado
                                    en
                                    el
                                    municipio: </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="matricula" id="matricula" class="form-control"
                                       placeholder="Numero de Matricula en Cámara de Comercio">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="emal" placeholder="Correo de Contacto"
                                       required="true"
                                       class="form-control">

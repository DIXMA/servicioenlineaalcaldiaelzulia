    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="numero" id="numero" class="form-control"
                               placeholder="Documento o Identificación" required="true" min="100000">
                        <span style="color: red;" id="errornumero"></span>
                    </div>
                    <div class="form-group">
                        <label for="nombres">* Apellidos y Nombres o Razón Social: </label>
                        <input type="text" class="form-control" name="nombres" id="nombres" required="true"
                    ...
                    <div class="form-group">
                        ...
                        @if(count($actividades) > 0)
                            <select class="form-control" name="actividadeconomica" id="actividadeconomica"
                                    required="true" onchange="cambioTipoActividad()">
                                <option value="x_x">- Seleccione una Opción -</option>
                                @foreach($actividades as $act)
                                    <option value="{{$act->id}}_{{$act->tipo_actividad}}">{{$act->codigo}}
                                        - {{$act->name}}</option>
                                @endforeach
                            </select>
                        @endif
                    ...
                    <div class="form-group">
                        <label for="direccionestablecimiento">* Dirección de establecimiento de comercio ubicado en el
                            municipio: </label>
                        <input type="text" class="form-control" name="direccionestablecimiento"
                               id="direccionestablecimiento" required="true"
                               placeholder="Dirección de establecimiento de comercio ubicado en el municipio">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">* Numero de Matricula en Cámara de Comercio: </label>
                        <input type="text" name="matricula" id="matricula" class="form-control" placeholder="Numero de Matricula en Cámara de Comercio">
                        <span style="color: red;" id="errormatricula"></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">* Fecha de Matricula en Cámara de Comercio: </label>
                        <input type="date" name="fecha_matricula" id="fecha_matricula" class="form-control">
                        <span style="color: red;" id="errorfecha_matricula"></span>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">* Fotocopia de la Cámara de Comercio: </label>
                        <input type="file" class="form-control" name="camaracomercio" id="camaracomercio" accept=".pdf"
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="emal" placeholder="Correo de Contacto" required="true"
                               class="form-control">
                        <span style="color: red;" id="erroremail"></span>
                    </div>
                </div>
                <div class="box-footer clearfix no-border">
                    <button type="button" class="btn btn-success pull-right" onclick="enviarForm('{{URL::to("/")}}')"><i
